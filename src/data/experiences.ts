...
export const experienceData: Experience[] = [
    {
        ...
        description: [
            'Executed functional and non-functional tests against the microservice architecture, using Postman to validate REST API endpoints and a JUnit framework for performance testing.',
            'Validated new cloud features, including a Google Cloud Pub/Sub integration, and used Docker to run performance tests and identify bottlenecks.',
            'Engineered a scalable, JSON-driven automation framework in Python to perform byte-level validation of TCP/IP and UDP message protocols for embedded IoT devices.',
            'Collaborated with the firmware team to debug low-level C code, identifying and removing legacy calculations to optimize performance and reduce device memory footprint.',
        ],
        techStack: [
